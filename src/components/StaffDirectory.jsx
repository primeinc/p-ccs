                                ...
                                <div className="space-y-4">
                                  {person.department && (
                                    <div className="flex items-start">
                                      <div className={`mr-3 ${colors.text}`}>
                                      ...
                                      <div>
                                        ...
                                        <p className="text-gray-800 font-medium">{person.department}</p>
                                      </div>
                                    </div>
                                  )}
                                  ...
                                  {person.email && (
                                    <div className="flex items-start">
                                      ...
                                      <div>
                                        ...
                                        <a href={`mailto:${person.email}`} className={`${colors.text} hover:underline font-medium`}>
                                          {person.email}
                                        </a>
                                      </div>
                                    </div>
                                  ...
                                  {person.specialization && (
                                    <div className="flex items-start">
                                      ...
                                      <div>
                                        <p className="text-xs text-gray-500 uppercase font-medium mb-1">Specialization</p>
                                        <p className="text-gray-800 font-medium">{person.specialization}</p>
                                      </div>
                                    </div>
                                  )}
                                </div>
                                  ...
                                  {person.education && (
                                    <div className="flex items-start">
                                      ...
                                      <div>
                                        ...
                                        <p className="text-gray-800 font-medium">{person.education}</p>
                                      </div>
                                    </div>
                                  )}
                                  ...
                                  {person.note && (
                                    <div className="flex items-start">
                                      ...
                                      <div>
                                        ...
                                        <p className="text-gray-800 font-medium">{person.note}</p>
                                      </div>
                                    </div>
                                  )}
                                </div>
                                ...
                                <div className="mt-4 pt-4 border-t border-gray-100">
                                  <div className="flex items-start">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-green-600 font-medium">{person.status}</p>
                                    </div>
                                  </div>
                                </div>
                              )}
